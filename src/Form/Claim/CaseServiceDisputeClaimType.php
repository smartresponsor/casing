...
final class CaseServiceDisputeClaimType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ->add('subject', ChoiceType::class, [
                ...
                'choice_label' => static fn (CaseServicePaymentSubject $subject): string => sprintf('%s · %s %s · %s', $subject->orderNumber, $subject->amount, $subject->currency, $subject->status),
                'choice_value' => static fn (?CaseServicePaymentSubject $subject): string => null === $subject ? '' : hash('sha256', $subject->paymentReference),
    ...
    {
        $resolver->setDefaults(['data_class' => CaseServiceDisputeClaimDTO::class, 'subjects' => [], 'types' => []]);
