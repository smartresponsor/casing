...
final readonly class CaseSupportHomeController
{
    public function __construct(
        ...
        private CaseServicePaymentSubjectResolverInterface $servicePayments,
        private CaseLeadSubjectResolverInterface $leadSubjects,
    ) {
    }
